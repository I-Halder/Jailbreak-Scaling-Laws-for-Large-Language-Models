...
## change the path to the models    
_MODELS = {
    "Vicuna-7B": ["./hugging_face_cache/hub/models--lmsys--vicuna-7b-v1.5/snapshots/3321f76e3f527bd14065daf69dad9344000a201d", {"use_fast": False}, "vicuna", 64],
    "Vicuna-13B": ["./hugging_face_cache/hub/models--lmsys--vicuna-13b-v1.5/snapshots/c8327bf999adbd2efe2e75f6509fa01436100dc2", {"use_fast": False}, "vicuna", 64], 
}
