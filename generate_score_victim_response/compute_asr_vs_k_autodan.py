...
if __name__ == "__main__":
    # Usage: python generate_score_victim_response/compute_asr_vs_k_autodan.py --k_min 1 --k_max 6 --k_step 4 --model_args "pretrained=meta-llama/Meta-Llama-3-8B-Instruct,tensor_parallel_size=1,data_parallel_size=1,gpu_memory_utilization=0.9" --output_path ./generation_results/ --tasks advbench_high_level_injection --yaml_path "./lm_eval/tasks/advbench/advbench_high_level_injection.yaml" --use_judge_model --limit 0.01 --jailbreak_file "vicuna_0_normal.json" --jailbreak_prompt_field "goal" --jailbreak_attack_field "final_suffix"
    main()